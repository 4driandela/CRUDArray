...
public class herramientas {
	/**
	 * Herramientas contiene metodos generales usados en el resto de clases. Método
	 * que pide por teclado una cadena.
	 * 
	 * @author Adriandela
	...
	/**
	 * Herramientas contiene metodos generales usados en el resto de clases. Método
	 * que comprueba que el número menú está entre los valores deseados.
	 * 
	 * @author Adriandela
	...
	/**
	 * Herramientas contiene metodos generales usados en el resto de clases. Método
	 * que recorre un array buscando algún espacio vacío para el usuario.
	 * 
	 * @author Adriandela
	...
	/**
	 * Herramientas contiene metodos generales usados en el resto de clases. Método
	 * que recorre un array comprobando si hay alguna posición utilizada, termina
	 * cuando encuentra uno o llega al final del array.
	 * 
	 * @author Adriandela
